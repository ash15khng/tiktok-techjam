...
10. Grow the current 65-test suite into at least 100 parser utterances, especially
   conjunction scope, short sizes, brand aliases, typos, and contextual replies
   that explicitly switch attributes.
11. Rerun latency and memory on the judging environment; local measurements are
   261 ms p95 and about 274 MiB steady working set.
12. Add the five members' contribution statements and rehearse the prepared
